...
def register_coco_instances(name, metadata, json_file, image_root, extra_arguments=None):
    """
    ...
    if extra_arguments is None:
        ...
        DatasetCatalog.register(name, lambda: load_coco_json(json_file, image_root, name, extra_arguments))
